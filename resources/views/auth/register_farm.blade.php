    ...
    <div class="row justify-content-center">
        <div class="card mt-4 shadow-lg">
            <div class="card-body">
                <!-- Title -->
                <div class="row">
                    <p class="title text-yellowgreen text-start ms-5 my-5 ps-3">
                        {{ __("Let's Resist Your Profile and Farm info") }}
                    </p>
                </div>
                ...
                <form method="GET" action="{{route('registerHome')}}">
                    ...
                    {{-- Zipcode --}}
                    <div class="col-auto align-center-end mx-5 mt-4">
                        <label for="zipcode" class="form-label">Farm Zip Code</label>
                        <div class="input-group">

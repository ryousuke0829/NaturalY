    ...
    <div class="card shadow-sm px-5 pb-5">
        ...
        <div class="row mt-4">
            <div class="col-auto">
                ...
                @else
                    <div class="d-flex flex-column align-items-center justify-content-center bg-light rounded-circle text-secondary" style="width: 100px; height: 100px;">
                ...
                <div class="row mb-2 d-flex">
                    <div class="col-8 flex-column">
                        @if ($farm->first_product)
                            <a href="#" class="badge rounded-pill text-bg-success text-decoration-none mb-1">{{ $farm->first_product }}</a>
                        @endif
                        @if ($farm->second_product)
                            <a href="#" class="badge rounded-pill text-bg-success text-decoration-none mb-1">{{ $farm->second_product }}</a>
                        @endif
                    </div>
                    <div class="col-4">

                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-md-9">
                            <div class="card-body mx-4 pb-0 pe-0">
                                <div class="row">
                                    <div class="col-10">
                                        <a href="{{ route('farmProfile', ['id' => $orderItem->item->user->id]) }}" class="text-decoration-none text-dark">
                                            <img src="{{ $orderItem->item->user->avatar }}" alt="{{ $orderItem->item->user->name }}" class="rounded-circle avatar-sm">
                                    ...
                                    <div class="col-2 d-flex my-auto">
                                        ...
                                        @else
                                            <a href="{{ route('consumer.review', ['orderItemId' => $orderItem->id]) }}" class="text-decoration-none h5 text-center text-secondary">
